...
const UserDataComponent = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 w-full bg-primary bg-opacity-10 md:p-10 p-3 rounded-md relative py-5">
      ...
      <div className="w-full flex pb-5 justify-center">
        <div className={`rounded-full w-fit p-2 my-auto bg-dark border ${userData?.accountActivated ? 'border-green-500' : 'border-red-500'}`}>
